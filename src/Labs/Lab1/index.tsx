export default function Lab1(){
    return  (
        <div id = "wd-lab1">
            ...
            by the heading Heading Tags. The font of the section headings are usually larger and 
            bolder than their subsection headings. This document uses headings to introduce topics 
            such as HTML Documents, HTML Tags, Heading Tags, etc. HTML heading tags can be used 
            ...
            <div id="wd-lists">
                ...
                My favorite recipe of Mapo Tofu:
                <ol id="wd-my-favorite-recipe-tofu">
                <li> Prepare the Tofu.</li>
                <li> Toast the Sichuan Peppercorns.</li>
                <li> Cook the Pork.</li>
                ...
                My favorite books(in no praticular order)
                <ul id="wd-my-books">
                    <li>Dune</li>
                ...
                Your favorite books(in no praticular order)
                <ul id="wd-my-books">
                    <li>Harry Potter</li>
                    <li>Lord of the Rings</li>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <input placeholder="yogi1002" id="wd-text-fields-username" /> <br />
                    <label htmlFor="wd-text-fields-password">Password:</label>
                    <input type="password" value="123" id="wd-text-fields-password" /> <br />
                    <label htmlFor="wd-text-fields-first-name">First name:</label>
                    <input type="text" title="Yogi" id="wd-text-fields-first-name" /> <br />
                    <label htmlFor="wd-text-fields-last-name">Last name:</label>
                    <input type="text" placeholder="Yu" 
                                    value="Wonderland" 
                                    title="The last name" 
